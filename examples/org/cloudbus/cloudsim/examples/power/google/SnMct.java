...
public class SnMct {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFolder = SnMct.class.getClassLoader().getResource("workload/planetlab").getPath();
		String outputFolder = "output";
		String workload = "9"; // PlanetLab workload
		String vmAllocationPolicy = "snm"; // DVFS policy without VM migrations

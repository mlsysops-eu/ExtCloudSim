...
public class Helper {
	...
	public static List<Vm> createVmList(int brokerId, int vmsNumber, String InputFolder)
		...
		int num=0;
//		BufferedReader input = new BufferedReader(new FileReader(InputFolder + "/" + "146-179_surfsnel_dsl_internl_net_colostate_557"));
		BufferedReader input = new BufferedReader(new FileReader(InputFolder + "/" + "vm_events_1425"));
		double total =0;
		Random rand = new Random(0);
	//	double q[] = {1.0, 1.4, 1.8, 2.2, 2.6, 3.0, 3.4, 3.8, 4.2, 4.6, 5.0, 5.4};
...
//	    if ((int)Math.ceil(intArray[1] * cpu) <= 2 && intArray[2] * ram1 < 512)
//            price = 0.0062/3600;
//	    else if ((int)Math.ceil(intArray[1] * cpu) <= 2 && intArray[2] * ram1 < 1024)
//	    	price = 0.0124/3600;
//	    else if ((int)Math.ceil(intArray[1] * cpu) <= 2 && intArray[2] * ram1 < 2048)
//	    	price = 0.0248/3600;
//	    else if ((int)Math.ceil(intArray[1] * cpu) <= 2 && intArray[2] * ram1 < 4096)
//	    	price = 0.0496/3600;
//	    else if (intArray[1] * cpu <= 2 && intArray[2] * ram1 < 8192)
//	    	price = 0.0992/3600;
//	    else if (intArray[1] * cpu <= 4 && intArray[2] * ram1 < 16384)
//	    	price = 0.1984/3600;
//	    else if (intArray[1] * cpu <= 8 && intArray[2] * ram1 < 32768)
//	    	price = 0.3968/3600;
//	    else
//	    	price = 0.896/3600;
		    double[][] pricingTable = {
...
//		System.out.println("The number of Vms that satisfy condition (price*3600 == 0.0408), though I do not know why this formula, is " + num);
		return vms;
	}

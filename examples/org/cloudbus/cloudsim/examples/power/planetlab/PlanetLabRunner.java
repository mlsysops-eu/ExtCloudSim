...
public class PlanetLabRunner extends RunnerAbstract {
	 ...
	 */
	@Override
	protected void init(String inputFolder, String myFolder) {
		try {
			...
			vmList = Helper.createVmList(brokerId, cloudletList.size(), myFolder);
			hostList = Helper.createHostList(PlanetLabConstants.NUMBER_OF_HOSTS);
	//		specialNode = Helper.createSpecialNode();
		} catch (Exception e) {
			e.printStackTrace();

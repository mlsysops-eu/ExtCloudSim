...
public class Cloudlet {
	...
	private UtilizationModel utilizationModelCpuMax;
	...
	public Cloudlet(
			...
			final UtilizationModel utilizationModelCpuMax,
	...
	public UtilizationModel getUtilizationModelCpuMax() {
		return utilizationModelCpuMax;
	}
	 ...
	 * @param utilizationModelCpu the new utilization model cpu
	 */
	public void setUtilizationModelCpuMax(final UtilizationModel utilizationModelCpuMax) {
		this.utilizationModelCpuMax = utilizationModelCpuMax;
	}
	...
	public double getUtilizationOfCpuMax(final double time) {
		return getUtilizationModelCpuMax().getUtilization(time);
	}

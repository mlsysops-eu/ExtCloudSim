...
public abstract class VmAllocationPolicy {
	...
	// The host list for datacenters
	private List<List<PowerHost>> hostofdatacenterList;
	...
	public abstract void setVmHistory();
	
	protected void setHostofDatacenterList(List<List<PowerHost>> hostofdatacenterList) {
		this.hostofdatacenterList = hostofdatacenterList;
	}


	public List<List<PowerHost>> getHostofDatacenterList() {

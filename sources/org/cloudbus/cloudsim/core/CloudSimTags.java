...
public class CloudSimTags {
	...
	/**
	 * Denotes a request to migrate a new VM crossing Datacenter
	 */
	public static final int CROSS_DATACENTER_VM_MIGRATE = BASE + 109;
	public static final int CROSS_DATACENTER_VM_MIGRATE_ACK = BASE + 123;

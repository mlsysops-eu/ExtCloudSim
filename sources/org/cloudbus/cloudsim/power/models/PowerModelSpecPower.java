...
public abstract class PowerModelSpecPower implements PowerModel {
	...
	public double getPowerEstimation(double utilization, double voltage, double frequency) {
		return powerEstimation(utilization, voltage, frequency);
	}

	public double getFrequency(int operatingPoint) {
		return frequency(operatingPoint);
	}
	
	public double getVoltage(int operatingPoint, int voltageClass, int configuration) {
		return voltage(operatingPoint, voltageClass, configuration);
	}
	
	public double getEstimationOverhead(int vmClass, int operatingPoint) {
		return estimationOverhead(vmClass, operatingPoint);
	}
	...
	protected abstract double powerEstimation(double utilization, double voltage, double frequency);
	protected abstract double frequency(int operatingPoint);
	protected abstract double voltage(int operatingPoint, int voltageClass, int configuration);
	protected abstract double estimationOverhead(int vmClass, int operatingPoint);

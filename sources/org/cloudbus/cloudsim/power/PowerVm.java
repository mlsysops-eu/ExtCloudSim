...
public class PowerVm extends Vm {
	...
	public PowerVm(
			...
			final double price,
			final int vmClass) {
		super(id, userId, mips, pesNumber, ram, bw, size, vmm, cloudletScheduler, sig, price, vmClass);
	...
	/*public PowerVm(
			...
			final int timestamp) {
		super(id, userId, mips, pesNumber, ram, bw, size, vmm, cloudletScheduler, maxLoad, timestamp);
		setSchedulingInterval(schedulingInterval);
	}*/
	/**
